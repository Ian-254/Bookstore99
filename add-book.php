...
//Get our form data
    ...
    $stmt = mysqli_prepare($con, "INSERT INTO `books`( `title`, `poster`, `description`,`genre`,`price`) VALUES (?,?,?,?,?)");
    //bind data
    ...
    <div class="row justify-content-center">
        <div class="col-md-5, col-sm-8,">
            ...
            <form action="add-book.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Poster</label>
                    <input type="file" accept="image/*" max-size="2024" class="form-control-file border shadow-sm"
                ...
                <div class="form-group">
                    ...
                    <select name="genre" class="form-control">
                        <option value="Thriller">Thriller Book</option>
                        <option value="Documentary">Documentary book</option>
                        <option value="Horror">Horror Book</option>
                        <option value="Action">Action Book</option>
                        <option value="Romance">Romance Book</option>
                    </select>
                </div>
                <div class="form-group">
                    <label>Price</label>
